...
ggplot(mpg, aes(x = displ, y = hwy, shape = class)) + geom_point() + plot_layout(ncol = 2)
```
...
2. 
    a) What does `geom_col()` do? How is it different from `geom_bar()`?
