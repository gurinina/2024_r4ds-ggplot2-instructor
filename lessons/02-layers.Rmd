...
```
 ...
 The first argument in `facet_grid` determines the faceting by column, the second by row. By default each of the facets share the same scale and range for x and y axes.
...
**Ans-2.4.1.4a:**
  ...
  b. What if you were interested in a specific class, e.g. compact cars? How would highlighting that group using only an additional layer added to the plot below?
